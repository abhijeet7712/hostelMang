...
public class AllEmployeeWorking extends javax.swing.JFrame {
    ...
    public AllEmployeeWorking() {
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from employeee where status='Working'");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile No", "Father Name", "Mother Name", "Email", "Address", "AAdhar", "Designation ", "Status"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 676, 400));
